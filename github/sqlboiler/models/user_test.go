...
func testUsersFind(t *testing.T) {
	...
	userFound, err := FindUser(tx, o.Userid)
	if err != nil {
		t.Error(err)
	}
...
var (
	userDBTypes = map[string]string{`Avatar`: `varchar`, `ChapterInfo`: `text`, `CharInfo`: `text`, `Diamond`: `int`, `DressUse`: `text`, `FriendHeroInfo`: `text`, `Gmlevel`: `int`, `Goods`: `text`, `Heros`: `text`, `IsInit`: `tinyint`, `LoginTime`: `timestamp`, `LogoutTime`: `timestamp`, `Prop`: `text`, `QualifyInfo`: `text`, `QualifyRecord`: `text`, `RankBox`: `text`, `Sex`: `tinyint`, `ShopLimitRecord`: `text`, `Showid`: `bigint`, `TimeProp`: `text`, `TreasureBox`: `text`, `Userid`: `bigint`, `WelfareInfo`: `text`, `WonderInfo`: `text`}
	_           = bytes.MinRead
)
