...
type User struct {
	...
	Gmlevel         int       `boil:"gmlevel" json:"gmlevel" toml:"gmlevel" yaml:"gmlevel"`
	Diamond         int       `boil:"diamond" json:"diamond" toml:"diamond" yaml:"diamond"`
	Heros           string    `boil:"heros" json:"heros" toml:"heros" yaml:"heros"`
	ShopLimitRecord string    `boil:"shop_limit_record" json:"shop_limit_record" toml:"shop_limit_record" yaml:"shop_limit_record"`
	TimeProp        string    `boil:"time_prop" json:"time_prop" toml:"time_prop" yaml:"time_prop"`
	TreasureBox     string    `boil:"treasure_box" json:"treasure_box" toml:"treasure_box" yaml:"treasure_box"`
	RankBox         string    `boil:"rank_box" json:"rank_box" toml:"rank_box" yaml:"rank_box"`
	DressUse        string    `boil:"dress_use" json:"dress_use" toml:"dress_use" yaml:"dress_use"`
	QualifyInfo     string    `boil:"qualify_info" json:"qualify_info" toml:"qualify_info" yaml:"qualify_info"`
	CharInfo        string    `boil:"char_info" json:"char_info" toml:"char_info" yaml:"char_info"`
	WonderInfo      string    `boil:"wonder_info" json:"wonder_info" toml:"wonder_info" yaml:"wonder_info"`
	QualifyRecord   string    `boil:"qualify_record" json:"qualify_record" toml:"qualify_record" yaml:"qualify_record"`
	ChapterInfo     string    `boil:"chapter_info" json:"chapter_info" toml:"chapter_info" yaml:"chapter_info"`
	FriendHeroInfo  string    `boil:"friend_hero_info" json:"friend_hero_info" toml:"friend_hero_info" yaml:"friend_hero_info"`
	Prop            string    `boil:"prop" json:"prop" toml:"prop" yaml:"prop"`
	Goods           string    `boil:"goods" json:"goods" toml:"goods" yaml:"goods"`
	WelfareInfo     string    `boil:"welfare_info" json:"welfare_info" toml:"welfare_info" yaml:"welfare_info"`
...
var UserColumns = struct {
	...
	CharInfo        string
	WonderInfo      string
	QualifyRecord   string
	ChapterInfo     string
	FriendHeroInfo  string
	Prop            string
	Goods           string
	WelfareInfo     string
	LoginTime       string
	...
	Diamond:         "diamond",
	Heros:           "heros",
	ShopLimitRecord: "shop_limit_record",
	TimeProp:        "time_prop",
	TreasureBox:     "treasure_box",
	RankBox:         "rank_box",
	DressUse:        "dress_use",
	QualifyInfo:     "qualify_info",
	CharInfo:        "char_info",
	WonderInfo:      "wonder_info",
	QualifyRecord:   "qualify_record",
	ChapterInfo:     "chapter_info",
	FriendHeroInfo:  "friend_hero_info",
	Prop:            "prop",
	Goods:           "goods",
...
var (
	userColumns               = []string{"userid", "showid", "avatar", "sex", "gmlevel", "diamond", "heros", "shop_limit_record", "time_prop", "treasure_box", "rank_box", "dress_use", "qualify_info", "char_info", "wonder_info", "qualify_record", "chapter_info", "friend_hero_info", "prop", "goods", "welfare_info", "login_time", "logout_time", "is_init"}
	userColumnsWithoutDefault = []string{"userid", "showid", "avatar", "heros", "shop_limit_record", "time_prop", "treasure_box", "rank_box", "dress_use", "qualify_info", "char_info", "wonder_info", "qualify_record", "chapter_info", "friend_hero_info", "prop", "goods", "welfare_info", "login_time", "logout_time"}
	userColumnsWithDefault    = []string{"sex", "gmlevel", "diamond", "is_init"}
...
func FindUser(exec boil.Executor, userid uint64, selectCols ...string) (*User, error) {
	userObj := &User{}
...
func UserExists(exec boil.Executor, userid uint64) (bool, error) {
	var exists bool
